...
function stopReps() {
    ...
    if (exerciseType === 'Bilateral') {
        ...
        reps = { LeftSideReps: parseInt(counterLeft.innerHTML), RightSideReps: parseInt(counterRight.innerHTML), ExerciseId: currentExercise };
        $.post("Home/SaveRepsBilateral", reps);
    }
    else {
        var counter = document.getElementById("counterUnilateral");
        reps = { Reps: parseInt(counter.innerHTML), ExerciseId: currentExercise };
